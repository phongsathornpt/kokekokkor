...
func (s *Service) update(ctx context.Context, providerID string, value *string) error {
	...
	ref := domaincredential.Ref{ProviderID: providerID, Kind: domaincredential.KindAPIKey}
...
func (s *Service) rollback(ctx context.Context, ref domaincredential.Ref, hadOld bool, oldValue string) error {
	if hadOld {
